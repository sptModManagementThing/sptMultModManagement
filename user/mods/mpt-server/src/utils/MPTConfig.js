...
let MPTConfig = class MPTConfig {
    ...
    constructor(preAkiModLoader, vfs, jsonUtil) {
        ...
        this.mptConfig = this.jsonUtil.deserializeJsonC(this.vfs.readFile(node_path_1.default.join(this.modPath, "assets/configs/mpt.jsonc")));
    }
    getConfig() {
...
exports.MPTConfig = MPTConfig;
exports.MPTConfig = MPTConfig = __decorate([
...
//# sourceMappingURL=MPTConfig.js.map