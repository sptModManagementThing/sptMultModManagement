...
exports.MPTSendItemController = void 0;
...
let MPTSendItemController = class MPTSendItemController {
    logger;
    eventOutputHolder;
    mailSendService;
    inventoryHelper;
    ...
    httpResponse;
    mptConfig;
    constructor(logger, eventOutputHolder, mailSendService, inventoryHelper, saveServer, itemHelper, httpResponse, mptConfig) {
        this.logger = logger;
    ...
    sendItem(pmcData, body, sessionID) {
...
exports.MPTSendItemController = MPTSendItemController;
exports.MPTSendItemController = MPTSendItemController = __decorate([
