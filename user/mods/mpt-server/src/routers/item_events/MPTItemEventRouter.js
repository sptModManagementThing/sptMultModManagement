...
exports.MPTItemEventRouter = void 0;
...
let MPTItemEventRouter = class MPTItemEventRouter extends Router_1.ItemEventRouterDefinition {
    ...
    getHandledRoutes() {
        return [
            new Router_1.HandledRoute("SendToPlayer", false)
        ];
    }
...
exports.MPTItemEventRouter = MPTItemEventRouter;
exports.MPTItemEventRouter = MPTItemEventRouter = __decorate([
...
//# sourceMappingURL=MPTItemEventRouter.js.map